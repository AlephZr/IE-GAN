...
from algos.iegan_trainer import IEGAN_Trainer
from core.params import Parameters
from core.utils import save_tags
...
parser.add_argument('--eval_criteria', type=str,help='Evaluation criteria Choices: E-GAN | IE-GAN | operator_test | IE-GAN_a1 | IE-GAN_a2 | IE-GAN_a3 | IE-GAN_a4',default='IE-GAN')
...
# parser.add_argument('--buffer', type=float, help='Buffer size in kilos', default=0.08)

parser.add_argument('--netD', type=str, default='FC2',
                    help='specify discriminator architecture [EGAN32 | EGAN64 | EGAN128 | DCGAN28 | DCGAN64 | DCGAN128 | WGAN | FC2]')
parser.add_argument('--netG', type=str, default='FC2',
                    help='specify generator architecture [EGAN32 | EGAN64 | EGAN128 | DCGAN28 | DCGAN64 | DCGAN128 | WGAN | FC2]')
...
ai = IEGAN_Trainer(args, model_constructor, env_constructor)
